...
public class ZzImageBox extends RecyclerView {
    ...
    private static class MyAdapter extends Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            if (holder.getPosition() == getItemCount() - 1 && !lastOne) {
                ...
                if (mDatas.get(holder.getPosition()).getPicFilePath() != null && mDatas.get(holder.getPosition()).getPicFilePath().length() != 0) {
                    holder.ivPic.setImageURI(Uri.fromFile(new File(mDatas.get(holder.getPosition()).getPicFilePath())));
                } else {
                ...
                holder.ivDelete.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (listener != null) {
                            listener.onDeleteClick(holder.getPosition(), mDatas.get(holder.getPosition()).getPicFilePath());
                        }
                    }
                });
                holder.ivPic.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (listener != null) {
                            listener.onImageClick(holder.getPosition(), mDatas.get(holder.getPosition()).getPicFilePath(), holder.ivPic);
                        }
                    }
                });
            }
