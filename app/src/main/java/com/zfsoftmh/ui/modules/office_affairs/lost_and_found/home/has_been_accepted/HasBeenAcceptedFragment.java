...
public class HasBeenAcceptedFragment extends BaseListFragment<HasBeenAcceptedPresenter, LostAndFoundItemInfo> implements
        HasBeenAcceptedContract.View {
    ...
    protected void loadData() {
        presenter.loadData(start_page, PAGE_SIZE, 1, DbHelper.getAppToken(context));
    }
    ...
    public static HasBeenAcceptedFragment newInstance() {
        return new HasBeenAcceptedFragment();
    }
}
