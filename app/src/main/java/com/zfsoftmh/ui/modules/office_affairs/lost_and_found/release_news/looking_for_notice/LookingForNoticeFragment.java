...
public class LookingForNoticeFragment extends BaseFragment<LookingForNoticePresenter> implements
        LookingForNoticeContract.View, View.OnClickListener, ReleaseNewsAdapter.OnItemClickListener,
        MineBottomSheetDialogFragment.OnViewClickListener, EasyPermissions.PermissionCallbacks {

    private static final String TAG = "LookingForNoticeFragment";
    ...
    private LinearLayout ll_recycler; //照片布局
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_look_for_notice;
    }

    @Override
    protected void initViews(View view) {
        et_title = (EditText) view.findViewById(R.id.fragment_look_for_notice_title);
        et_location = (EditText) view.findViewById(R.id.fragment_look_for_notice_location);
        et_detail = (EditText) view.findViewById(R.id.fragment_look_for_notice_detail);
        btn_release = (Button) view.findViewById(R.id.fragment_look_for_notice_release);
        ll_recycler = (LinearLayout) view.findViewById(R.id.fragment_lost_and_found_image);
        et_phone_number = (EditText) view.findViewById(R.id.fragment_looking_for_notice_number);
    ...
    public static LookingForNoticeFragment newInstance() {
        return new LookingForNoticeFragment();
    }
    ...
    public void onClick(View view) {
         ...
         * 发布
         */
        case R.id.fragment_look_for_notice_release:
            submit();
            break;
    ...
    public void submit() {
        ...
        if (checkValueIsNull(title)) {
            showToastMsgShort(getResources().getString(R.string.look_for_notice_msg));
            return;
        }
        ...
        if (checkValueIsNull(detail)) {
            showToastMsgShort(getResources().getString(R.string.look_for_notice_detail));
            return;
        }
        ...
        Map<String, RequestBody> map = buildParams(title, location, detail, phoneNumber, 0);
