...
class SettlementMattersAdapter extends RecyclerView.Adapter<SettlementMattersAdapter.ViewHolder> {

    private LayoutInflater inflater;
    private List<AgencyMattersInfo> list;
    private OnItemClickListener listener;

    public SettlementMattersAdapter(Context context) {
        if (context != null) {
    ...
    void setDadaSource(List<AgencyMattersInfo> list) {
        this.list = list;
