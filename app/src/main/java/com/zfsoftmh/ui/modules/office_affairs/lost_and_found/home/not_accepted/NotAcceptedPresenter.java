 ...
 * @author wesley
 * @date: 2017-5-27
 * @Description: 未招领presenter
 */

public class NotAcceptedPresenter implements NotAcceptedContract.Presenter {
    ...
    NotAcceptedPresenter(NotAcceptedContract.View view, OfficeAffairsApi officeAffairsApi,
