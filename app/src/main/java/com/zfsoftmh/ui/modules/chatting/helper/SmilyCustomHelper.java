 ...
 *
 * 通过设置以上三个值来进行表情的功能的扩展，以上三个值的个数是一致的
 */
public class SmilyCustomHelper {
	/**
    ...
    /**
     * 添加新的表情包,该方法添加的表情是图片类型,无需考虑多端解析问题
     ...
     * @param meanings 含义数组
     * <br>
     * 注:该方法添加的表情属于自定义Emoji表情,填加后的展示需要自己考虑多端解析的实现
     */
    ...
    /**
     * 导入新的表情包示例代码,调用{@link #addEmojiSmiley(int[], String[], String[])}
